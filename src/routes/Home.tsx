...
import Section from '../components/common/Section'; // Import the reusable Section component
import CarouselSection from '../components/common/CarouselSection'; // Import the CarouselSection component
